public class Main {
    public static void main(String[] args) {
        ...
        company.addEmployee(new Employee(2, "anurag", "tester", 50000));
        company.addEmployee(new Employee(3, "priya", "sys admin", 60000));
        company.addEmployee(new Employee(4, "aryan", "hr", 80000));
        company.addEmployee(new Employee(5, "riya", "network engineer", 70000));
